...
const Notification = () => {
  ...
  const incomingRequest = friendreq?.incomingrequest || []
  const acceptedRequest = friendreq?.acceptedrequest || []
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1.5 mt-1">
                                <span className="badge badge-secondary badge-sm">
                                  Native: {request.sender.native_language}
                                </span>
                                <span className="badge badge-outline badge-sm">
                                  Learning: {request.sender.learning_language}
                                </span>
                              </div>
                            </div>
                          </div>
